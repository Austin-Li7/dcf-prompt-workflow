...
import { lookupDamodaranBeta } from "@/lib/damodaran-betas";
...
export async function GET(req: NextRequest): Promise<NextResponse<WACCDataResponse>> {
  try {
      ...
      return NextResponse.json(
        {
          ...
          companyDescription: "", industry: "", sector: "", damodaranBeta: null, damodaranIndustry: null,
    ...
    let industry = "";
    let sector = "";
    let damodaranBeta: number | null = null;
    let damodaranIndustry: string | null = null;
    ...
    try {
      ...
      if (betaMatch) {
        damodaranBeta = betaMatch.beta;
        damodaranIndustry = betaMatch.damodaranIndustry;
      }
